...
public class FragmenFourContactListAdapter extends BaseAdapter{

	public ArrayList<ContactsBE> alOfContacts=null;
	private boolean useList = true;
	private Context context=null;
	FragmenFourContactListAdapter(Context context,ArrayList<ContactsBE> alOfContacts)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ContactsBE objContact=alOfContacts.get(position);
		View viewToUse = null;  // we want to support a grid or list view. 
		
		LayoutInflater mInflater = (LayoutInflater) context .getSystemService(Activity.LAYOUT_INFLATER_SERVICE); 
		if (convertView == null) { 
			if(useList){ viewToUse = mInflater.inflate(R.layout.contact_list_row, null);
			} else {
			...
			holder.txtAddress = (TextView)viewToUse.findViewById(R.id.tvAddress);
