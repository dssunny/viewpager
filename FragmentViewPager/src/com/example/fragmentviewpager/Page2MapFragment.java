...
public class Page2MapFragment extends Fragment {

private static View objView;

public static Page2MapFragment newInstance(String text) {
	Page2MapFragment pageFragment = new Page2MapFragment();
...
private static void setUpMap() {
    ...
    objMap.clear();
    ArrayList<ZipBE> countryList = Page1Fragment.objZipListAdapter.alZipList;
    for(int i=0;i<countryList.size();i++){
     ZipBE country = countryList.get(i);
...
public void onDestroyView() {
    super.onDestroyView();
    if (objMap != null) {
        MainActivity.objFragmentManager.beginTransaction()
            .remove(MainActivity.objFragmentManager.findFragmentById(R.id.page2map)).commit();
        objMap = null;
    }
}
