...
public class ClsCurrentLocationFragment extends Fragment {

	private static View objView;

	public static ClsCurrentLocationFragment newInstance(String text) {
		ClsCurrentLocationFragment pageFragment = new ClsCurrentLocationFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Location objLocation = ClsLocationTracker.getInstance(getActivity())
				.getLocation();
	...
	public void onDestroyView() {
		super.onDestroyView();
		if (objMap != null) {
			ClsLauncher.objFragmentManager
					.beginTransaction()
					.remove(ClsLauncher.objFragmentManager
